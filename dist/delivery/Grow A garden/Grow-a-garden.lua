...
-- watermark: Y2k-NltWkdgB5JBM
return Vm.run("", { name = 'Grow A garden/Grow-a-garden', checksum = 2958163137, interval = 2, watermark = 'Y2k-NltWkdgB5JBM', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Grow%20A%20garden%2FGrow-a-garden', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'vstCa7cihnPaLxm2sweHv6OQ' } })
