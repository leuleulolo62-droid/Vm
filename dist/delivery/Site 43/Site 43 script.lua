...
-- watermark: Y2k-PdICDxPLKvzq
return Vm.run("", { name = 'Site 43/Site 43 script', checksum = 1344040020, interval = 2, watermark = 'Y2k-PdICDxPLKvzq', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Site%2043%2FSite%2043%20script', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'RvMJzMwqEsJXSkqAIDChbEVL' } })
