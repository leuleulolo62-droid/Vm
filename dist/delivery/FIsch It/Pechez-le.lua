...
-- watermark: Y2k-5hvWELQbKfwv
return Vm.run("", { name = 'FIsch It/Pechez-le', checksum = 345150343, interval = 2, watermark = 'Y2k-5hvWELQbKfwv', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=FIsch%20It%2FPechez-le', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = '4u5HGQAM766SdNs5rOTrpfgQ' } })
