...
-- watermark: Y2k-FjUoNyl9XZec
return Vm.run("", { name = 'Loader/Loader', checksum = 3399389314, interval = 2, watermark = 'Y2k-FjUoNyl9XZec', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Loader%2FLoader', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'hojCeMB4tm3S099ZJz1lv465' } })
