...
-- watermark: Y2k-OdVGr1MigALH
return Vm.run("", { name = 'Sell a Lemon/Sell a Lemon', checksum = 2454316622, interval = 2, watermark = 'Y2k-OdVGr1MigALH', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Sell%20a%20Lemon%2FSell%20a%20Lemon', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'mvr5PH8qghCBQGgAICNaurLD' } })
