...
-- watermark: Y2k-aKP1lL7bmHGq
return Vm.run("", { name = 'Slime rng/SlimeRNG_Script', checksum = 156284418, interval = 2, watermark = 'Y2k-aKP1lL7bmHGq', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Slime%20rng%2FSlimeRNG_Script', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'xaUOwA4X9nwQjD0m8uuwCue7' } })
