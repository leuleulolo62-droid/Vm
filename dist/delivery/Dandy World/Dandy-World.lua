...
-- watermark: Y2k-PjA9V9T1CU2V
return Vm.run("", { name = 'Dandy World/Dandy-World', checksum = 3492352745, interval = 2, watermark = 'Y2k-PjA9V9T1CU2V', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Dandy%20World%2FDandy-World', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'hTMkdYCMRCdUFs0s72OEEUMK' } })
