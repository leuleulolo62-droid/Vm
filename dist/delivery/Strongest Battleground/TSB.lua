...
-- watermark: Y2k-SOrtAp0cAIW4
return Vm.run("", { name = 'Strongest Battleground/TSB', checksum = 391249616, interval = 2, watermark = 'Y2k-SOrtAp0cAIW4', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Strongest%20Battleground%2FTSB', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'xalIYdQlUa8DcZEsge9ZhWdO' } })
