...
-- watermark: Y2k-D4URXzVwSHKW
return Vm.run("", { name = 'Keyboard escape/keyboard escape', checksum = 1715464684, interval = 2, watermark = 'Y2k-D4URXzVwSHKW', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Keyboard%20escape%2Fkeyboard%20escape', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'wwgNDQawbB94sX8UJf7tXDPN' } })
