...
-- watermark: Y2k-MuIkO8SzjSXD
return Vm.run("", { name = 'RIVALS/Rivals', checksum = 2720453310, interval = 2, watermark = 'Y2k-MuIkO8SzjSXD', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=RIVALS%2FRivals', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'tfMMKZus3zfuFmrvlX47z8z9' } })
