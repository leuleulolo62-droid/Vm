...
-- watermark: Y2k-9nTdEQ1IpPhd
return Vm.run("", { name = 'VolleyBall Legend/VolleyBall-Legends', checksum = 427908111, interval = 2, watermark = 'Y2k-9nTdEQ1IpPhd', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=VolleyBall%20Legend%2FVolleyBall-Legends', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = '3cr7qbrvZXZmOrDsOQKUF4P4' } })
