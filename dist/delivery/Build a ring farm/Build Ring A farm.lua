...
-- watermark: Y2k-hKGoAzewgsCj
return Vm.run("", { name = 'Build a ring farm/Build Ring A farm', checksum = 703594195, interval = 2, watermark = 'Y2k-hKGoAzewgsCj', neuterAC = true, antiSpy = { kick = true, halt = true }, deliver = { endpoint = 'https://y2k-keys.y2kscript.workers.dev/deliver?name=Build%20a%20ring%20farm%2FBuild%20Ring%20A%20farm', key = (getgenv and (getgenv().SCRIPT_KEY or getgenv().Key)) or _G.Key, cryptKey = 'yTT27gke6b2t62A2UVdvaQku' } })
